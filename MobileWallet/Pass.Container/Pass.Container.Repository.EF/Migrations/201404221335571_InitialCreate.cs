        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        DeviceId = c.String(nullable: false, maxLength: 512),
                    })
                ...
                c => new
                    {
                        ...
                        AuthToken = c.String(nullable: false, maxLength: 512),
                        SerialNumber = c.String(nullable: false, maxLength: 512),
                        PassTypeIdentifier = c.String(nullable: false, maxLength: 512),
                ...
                c => new
                    {
                        ...
                        DefaultValue = c.String(maxLength: 512),
                        DefaultLabel = c.String(maxLength: 512),
                        Version = c.Int(nullable: false),
                        CreatedDate = c.DateTime(nullable: false),
                        UpdatedDate = c.DateTime(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        PassTypeId = c.String(nullable: false, maxLength: 512),
                        CertificateStorageItemId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.PassTemplateNativeId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ClientDeviceId = c.Int(nullable: false),
                        PushToken = c.String(nullable: false, maxLength: 512),
                    })
                .PrimaryKey(t => t.ClientDeviceId)
